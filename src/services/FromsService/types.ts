...
export type GetSubmitHandler = (params: GetSubmitHandlerParams) => () => void;
...
export type UseFormHook = (params: UseFormHookParams) => UseFormHookResult;
